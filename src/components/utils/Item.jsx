  ...
  return (
    <>
      ...
      >
        ...
        >
          <h4 className="text-slate-200 text-xl lg:text-lg md:text-base font-medium filter drop-shadow">
            {title}
          </h4>
          ...
          <div className="flex items-center justify-between w-28 my-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <h4 className="md:text-sm font-normal text-slate-100">
                {rating}
              </h4>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="bg-white/90 blur-effect-theme button-theme px-2 py-1 text-sm text-black"
              onClick={() => {
                onAddToCart();
                onCartToggle();
              }}
